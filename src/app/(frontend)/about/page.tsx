...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.cm8vvip.com/about' },
}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.cm8vvip.com' },
              {
                ...
                position: 2,
                name: 'Tentang Kami',
                item: 'https://www.cm8vvip.com/about',
              },
            ],
          }),
        }}
        ...
        <div className="section-inner">
          <div className="about-grid">
            <div className="about-content">
              ...
              <p>
                Visi kami adalah untuk menjadi platform agent #1 di Asia Tenggara, dengan memberikan
                komisyen tertinggi, sokongan terbaik, dan pengalaman yang tiada tandingan.
              </p>
            </div>
