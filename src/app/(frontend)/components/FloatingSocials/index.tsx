    ...
    <div className="floating-socials-container">
      ...
      <div className={`floating-menu ${isOpen ? 'is-open' : ''}`}>
        <div className="floating-menu-header">
          <h4>Sokongan & Komuniti</h4>
          <p>Pilih platform pilihan anda</p>
        </div>
      ...
      {/* Optional tooltip bubble when closed */}
      {!isOpen && <div className="floating-tooltip">Chat / Info</div>}
    </div>
  )
}
