...
export const metadata: Metadata = {
  alternates: { canonical: 'https://www.cm8vvip.com/komisen-tanpa-modal' },
  ...
  openGraph: {
    ...
    url: 'https://www.cm8vvip.com/komisen-tanpa-modal',
    siteName: 'CM8 VVIP',
    type: 'website',
  },
}
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              { '@type': 'ListItem', position: 1, name: 'Home', item: 'https://www.cm8vvip.com' },
              {
                ...
                item: 'https://www.cm8vvip.com/komisen-tanpa-modal',
              },
            ],
          }),
        }}
