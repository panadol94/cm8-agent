...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'win-gallery': WinGallerySelect<false> | WinGallerySelect<true>;
...
/**
 * Screenshot kemenangan pemain CM8 untuk dipapar di homepage gallery.
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "win-gallery".
 */
export interface WinGallery {
  id: number;
  /**
   * Upload screenshot telefon (portrait/vertical). Saiz disyorkan: 1080 x 1920.
   */
  image: number | Media;
  /**
  ...
  /**
   * Jumlah kemenangan (optional).
   */
  amount?: string | null;
  /**
   * Nama game yang dimainkan (optional).
   */
...
/**
 * Rekod penggunaan scan harian setiap pengguna. Boleh ban atau tambah bonus scan.
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "scan-usage".
 */
export interface ScanUsage {
  id: number;
  /**
   * Nombor telefon pengguna (dari OTP login)
   */
  phone: string;
  /**
   * ID permainan CM8 pengguna (jika ada)
   */
  cm8Username?: string | null;
  /**
   * Format: YYYY-MM-DD
   */
  date: string;
  /**
   * Berapa kali user dah scan hari ini
   */
  scanCount?: number | null;
  /**
   * Scan tambahan yang diberi oleh admin
   */
  bonusScans?: number | null;
  /**
   * Tandakan untuk sekat pengguna ini daripada menggunakan scanner.
   */
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'win-gallery';
        value: number | WinGallery;
      } | null)
    | ({
        relationTo: 'faqs';
        value: number | Faq;
    ...
    | ({
        relationTo: 'scan-usage';
        value: number | ScanUsage;
      } | null)
    | ({
        relationTo: 'users';
        value: number | User;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "win-gallery_select".
 */
export interface WinGallerySelect<T extends boolean = true> {
  image?: T;
  playerName?: T;
  amount?: T;
  gameName?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "scan-usage_select".
 */
export interface ScanUsageSelect<T extends boolean = true> {
  phone?: T;
  cm8Username?: T;
  date?: T;
  scanCount?: T;
